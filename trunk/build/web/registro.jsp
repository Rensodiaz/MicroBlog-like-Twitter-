<%-- 
    Document   : registro
    Created on : Jun 26, 2013, 10:30:09 PM
    Author     : Luis
--%>
...
<html>
    ...
    <body>
        <nav><a href="./login.jsp">Log In</a> | <a href="./registro.jsp" class="focus">Registrar</a> | <a href="./UsuarioController?accion=entrarComoInvitado">Entrar como invitado</a> </nav>

        
        <form action="./UsuarioController" class="register">
            ...
            <input type="text" name="username" class="text-field" placeholder="Username" maxlength="20" />
            <input type="password" name="password" class="text-field" placeholder="Contraseña" maxlength="20" />
            <input type="text" name="nombre" class="text-field" placeholder="Nombre" maxlength="20" />
            <input type="text" name="apellidos" class="text-field" placeholder="Apellidos" maxlength="20" />
            <input type="email" name="email" class="text-field" placeholder="Email" maxlength="50" />
